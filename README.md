...
> A curated list of **streaming agents**, covering AI systems (VLM/VLA/video gen.) that are **time-sensitive**, **real-time responsive**, **proactive** (continuously activated without explicit user prompts), and capable of processing **unbounded streaming inputs**. Papers listed in reverse chronological order.
...
**Note on AI-Generated / Automated Research:**
With the rise of AI agents in scientific discovery, we notice an increasing number of exploratory preprints fully or heavily generated by automated AI research pipelines. While we respect these automated explorations, their technical depth, soundness, and reproducibility may vary significantly from traditional human-authored peer-reviewed works. To help readers filter information efficiently, such papers will be explicitly tagged.
...
- **The Latent Bridge**: *The Latent Bridge: A Continuous Slow–Fast Channel for Real-Time Game Agents*. *arXiv, Jun 2026*. 
  > *(Note: This work appears to be generated by auto-research agents.)*
